document.addEventListener('DOMContentLoaded', function() {
    ...
    voprosi = [
        [vopros_1Per, pr_otv_zadachi_1Per],
        [vopros_2Per, pr_otv_zadachi_2Per],
        [vopros_3Per, pr_otv_zadachi_3Per],
        [vopros_4Per, pr_otv_zadachi_4Per],
        [vopros_5Per, pr_otv_zadachi_5Per],
        [vopros_6Per, pr_otv_zadachi_6Per],
        [vopros_7Per, pr_otv_zadachi_7Per],
        [vopros_8Per, pr_otv_zadachi_8Per],
        [vopros_9Per, pr_otv_zadachi_9Per],
        [vopros_10Per, pr_otv_zadachi_10Per],
        [vopros_11Per, pr_otv_zadachi_11Per],
        [vopros_12Per, pr_otv_zadachi_12Per],
        [vopros_13Per, pr_otv_zadachi_13Per],
        [vopros_14Per, pr_otv_zadachi_14Per],
        [vopros_15Per, pr_otv_zadachi_15Per]
    ];
