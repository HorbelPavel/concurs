document.addEventListener('DOMContentLoaded', function() {
    ...
    voprosi = [
        [vopros_1Res, pr_otv_zadachi_1Res],
        [vopros_2Res, pr_otv_zadachi_2Res],
        [vopros_3Res, pr_otv_zadachi_3Res],
        [vopros_4Res, pr_otv_zadachi_4Res],
        [vopros_5Res, pr_otv_zadachi_5Res],
        [vopros_6Res, pr_otv_zadachi_6Res],
        [vopros_7Res, pr_otv_zadachi_7Res],
        [vopros_8Res, pr_otv_zadachi_8Res],
        [vopros_9Res, pr_otv_zadachi_9Res],
        [vopros_10Res, pr_otv_zadachi_10Res],
        [vopros_11Res, pr_otv_zadachi_11Res],
        [vopros_12Res, pr_otv_zadachi_12Res],
        [vopros_13Res, pr_otv_zadachi_13Res],
        [vopros_14Res, pr_otv_zadachi_14Res],
        [vopros_15Res, pr_otv_zadachi_15Res]
    ];
